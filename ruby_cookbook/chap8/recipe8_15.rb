...
#frozen_string.gsub!('r', 'a') # => TypeError: can't modify frozen string

sequences = [[1,2,3], [1,2,4], [1,4,9]].freeze
#sequences << [2,3,5] # => TypeError: can't modify frozen array
...
# Freezing an object does not prevent reassignement of any variables bound
...
class MySubclass < MyClass
  def my_method
    "This is only one of the method available in MySubclass."
  end
