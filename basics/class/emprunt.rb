  ...
  def echeancier
    ...
    File.open('echeancier.txt', 'w') do |f|
        @duree.times do |i|
            ...
            f.puts "#{date_format.center(18)} #{paiement_format.center(18)} #{solde_restant_format.center(14)}"
...
STDOUT.reopen(File.open('echeancier.txt', 'w'))

puts ""
puts "***************************************************"
puts "Date: #{date_debut}"
puts "Montant du prêt: #{montant}"
puts "Durée du prêt: #{duree} ans"
puts "Paiement mensuel: #{emprunt.paiement_mensuel.round(2)}€"
puts "***************************************************"
puts "Date du paiement - Paiement mensuel - Solde restant"
puts "***************************************************"
emprunt.echeancier
puts "***************************************************"
puts "Fait le:              à              ;"
